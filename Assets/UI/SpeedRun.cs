...
public class SpeedRun : MonoBehaviour
{
    ...
    float startingTime = 0f; //this will be the time that the player took to start the game, and will be removed from the time each time the textTime is calculated
